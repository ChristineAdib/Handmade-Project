...
public interface IReviewService
{
    ...
    Task<Result<ReviewResponseDto>> CreateReview(CreateReviewDto dto, string userId, bool bypassValidation = false, DateTime? customCreatedAt = null);
    ...
    Task<Result> GenerateDemoReviewsAsync(Guid productId, string userId);
    Task<Result> GenerateAiSummaryAsync(Guid productId);
}
